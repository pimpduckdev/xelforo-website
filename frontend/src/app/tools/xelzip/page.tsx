      ...
      <section className="py-24 px-6 bg-[#0a0a0a]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">
            Command Line <span className="text-[#00ff88]">Interface</span>
          </h2>
          <div className="space-y-4">
            {[
              ...
              <div key={item.cmd} className="bg-[#111] border border-[#00ff88]/10 rounded-xl p-5 flex flex-col sm:flex-row sm:items-center gap-3">
                <code className="text-[#00ff88] font-mono text-sm bg-[#0a0a0a] px-3 py-2 rounded-lg flex-shrink-0">{item.cmd}</code>
      ...
      <section id="download" className="py-24 px-6 bg-[#080808]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Download <span className="text-[#00ff88]">Xelzip</span>
          </h2>
          ...
          <p className="text-xs text-zinc-600 mt-6">
            Source code on <a href="https://github.com/xelforo/xelzip" target="_blank" rel="noopener noreferrer" className="text-[#00ff88] hover:underline">GitHub</a>
          </p>
        </div>
      </section>
    </div>
